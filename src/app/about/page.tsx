    ...
    return (
        <div>
            ...
            <div className="w-full md:px-[130px]">
                {/* Who We Are Section */}
                <section className="py-2  md:py-10 items-center display flex justify-between">
                    ...
                    <div className="w-full md:w-[calc(100% - 422px)] px-2 md:px-0">
                        <h2 className="text-xl md:text-4xl font-bold mb-4 md:text-left text-center font-heading">Who We Are</h2>
                        <p className="text-gray-700 text-sm md:text-xl md:text-left leading-relaxed font-body mb-4">
                        ...
                        <p className="text-gray-700 text-sm md:text-xl md:text-left leading-relaxed font-body">
